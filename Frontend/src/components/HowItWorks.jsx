...
const HowItWorks = () => {
  return (
    <section className='my-8'>
        ...
        <aside className='mt-8 grid grid-cols-[repeat(auto-fill,minmax(300px,1fr))] max-[1525px]:grid-cols-[repeat(auto-fill,minmax(250px,1fr))] gap-4 *:flex *:flex-col *:items-center *:border-2 *:border-black *:rounded-2xl *:bg-gray-900 max-[540px]:grid-cols-1 *:shadow-sm *:shadow-gray-200'>
            <div>
